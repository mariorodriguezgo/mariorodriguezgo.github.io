...
const T = {
  es: {
    ...
    "cert6-title":"Technical Introduction to Cybersecurity 3.0","cert6-desc":"Fortinet · NSE 2","cert7-title":"FortiGate 7.6 Operator","cert7-desc":"Fortinet","cert8-title":"Fortinet Certified Associate Cybersecurity","cert8-desc":"Fortinet · FCA",
    ...
    "comp-netsec":"Seguridad de Redes","comp-secconcepts":"Conceptos de Seguridad","comp-fortigate":"Administración FortiGate","comp-secops":"Operaciones de Seguridad","comp-protection":"Protección de Endpoints",
    ...
    "harea-data":"Bases de Datos","comp-sgbd":"SGBD","comp-sql":"Lenguaje SQL","comp-web":"Servidores Web","comp-hardware":"Hardware & Mantenimiento","hw-mount":"Montaje y Reparación","hw-diag":"Diagnóstico de Averías","hw-maint":"Mantenimiento Preventivo","sql-queries":"Consultas","sql-backup":"Backups de BD","net-mail":"Correo (SMTP/IMAP)","comp-netinfra":"Infraestructura de Red","comp-netsvc":"Servicios de Red","comp-secnet":"Conectividad Segura",
  ...
  cat: {
    ...
    "comp-netsec":"Seguretat de Xarxa","comp-secconcepts":"Conceptes de Seguretat","comp-fortigate":"Administració FortiGate","comp-secops":"Operacions de Seguretat","comp-protection":"Protecció d'Endpoints",
    ...
    "harea-data":"Bases de Dades","comp-sgbd":"SGBD","comp-sql":"Llenguatge SQL","comp-web":"Servidors Web","comp-hardware":"Maquinari & Manteniment","hw-mount":"Muntatge i Reparació","hw-diag":"Diagnòstic d'Avaries","hw-maint":"Manteniment Preventiu","sql-queries":"Consultes","sql-backup":"Backups de BD","net-mail":"Correu (SMTP/IMAP)","comp-netinfra":"Infraestructura de Xarxa","comp-netsvc":"Serveis de Xarxa","comp-secnet":"Connectivitat Segura",
  ...
  en: {
    ...
    "comp-netsec":"Network Security","comp-secconcepts":"Security Concepts","comp-fortigate":"FortiGate Administration","comp-secops":"Security Operations","comp-protection":"Endpoint Protection",
    ...
    "harea-data":"Databases","comp-sgbd":"DBMS","comp-sql":"SQL Language","comp-web":"Web Servers","comp-hardware":"Hardware & Maintenance","hw-mount":"Assembly & Repair","hw-diag":"Fault Diagnosis","hw-maint":"Preventive Maintenance","sql-queries":"Queries","sql-backup":"DB Backups","net-mail":"Mail (SMTP/IMAP)","comp-netinfra":"Network Infrastructure","comp-netsvc":"Network Services","comp-secnet":"Secure Connectivity",
